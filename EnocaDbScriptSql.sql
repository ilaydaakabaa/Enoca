...
CREATE TABLE [CarrierConfigurations] (
    ...
    CONSTRAINT [FK_CarrierConfigurations_Carriers_CarrierId] FOREIGN KEY ([CarrierId]) REFERENCES [Carriers] ([CarrierId]) ON DELETE NO ACTION
);
GO
...
VALUES (N'20260116134402_InitialCreate', N'6.0.36');
GO
